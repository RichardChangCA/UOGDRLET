...
with tf.variable_scope('model', reuse=True):
    ...
    env.x_fgmt = fast_gradient.fgmt(model, env.x, 9, epochs=env.fgsm_epochs, eps=env.fgsm_eps)
...
gs = gridspec.GridSpec(1, 9, wspace=0.05, hspace=0.05)
